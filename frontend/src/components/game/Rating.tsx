      ...
      {userId ? (
        hasPurchased ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-600 text-gray-800 placeholder-gray-400 h-24 resize-none"
          ...
          <p className="mt-6 text-lg text-gray-600">
            You must purchase this game to leave a rating and comment.
          </p>
        )
      ) : (
        <p className="mt-6 text-lg text-gray-600">
          Please <a onClick={()=> {loginModal.open()}} className="text-red-600 hover:underline">log in</a> to leave a rating and comment.
        </p>
      )}
